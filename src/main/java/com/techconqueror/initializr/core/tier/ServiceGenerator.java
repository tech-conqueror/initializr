package com.techconqueror.initializr.core.tier;
...
public class ServiceGenerator {
     ...
     * </pre>
     *
     * @param entityClassMetadata the metadata of the entity for which the service implementation is to be generated.
     ...
     */
    public static void generateService(String packageName, EntityClassMetadata entityClassMetadata, String outputPath)
            throws IOException {
