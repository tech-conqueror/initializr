...
import static com.techconqueror.initializr.core.layer.RepositoryGenerator.generateRepository;
import static com.techconqueror.initializr.core.layer.RestControllerGenerator.generateController;
import static com.techconqueror.initializr.core.layer.ServiceGenerator.generateService;
...
public class HibernateEntityGenerator {
    ...
    private static void generateEntityFromTable(
        ...
        var metadata = fetchTableMetadata(packageName + ".entity", tableName, connection);
    ...
    private static void generateEntityFile(EntityClassMetadata metadata, String outputPath) throws IOException {
        var entityClass = ClassSource.createClass(metadata.getName())
                ...
                .build();
        var javaFile = JavaFile.builder(metadata.getPackageName(), entityClass).build();
