...
/**
 * Represents metadata for a Java class that is used in code generation. This class encapsulates the
 * package name, class name, annotations, fields, and additional configurations like whether a
...
public class ClassMetadata {
   ...
   *
   * @param isNoArgsConstructorNeeded {@code true} if a no-args constructor is needed; {@code false}
   *                                  otherwise.
   */
