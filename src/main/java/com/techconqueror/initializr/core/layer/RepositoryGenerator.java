...
public class RepositoryGenerator {
     ...
     * @param entityClassMetadata the metadata of the entity for which the repository is to be generated.
    ...
    public static void generateRepository(
        ...
        var repositoryName = entityClassMetadata.getName() + "Repository";

        // Create a JavaPoet TypeSpec for the repository interface
        var repositoryInterface = TypeSpec.interfaceBuilder(repositoryName)
        ...
        // Build the Java file
        var javaFile = JavaFile.builder(packageName + ".repository", repositoryInterface)
                .build();
