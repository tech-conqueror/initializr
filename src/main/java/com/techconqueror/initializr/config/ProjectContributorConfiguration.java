...
import com.techconqueror.initializr.contributor.LayerFileProjectContributor;
...
public class ProjectContributorConfiguration {
    ...
    @Bean
    public LayerFileProjectContributor layerFileProjectContributor(ProjectDescription projectDescription) {
        return new LayerFileProjectContributor(projectDescription);
    }
