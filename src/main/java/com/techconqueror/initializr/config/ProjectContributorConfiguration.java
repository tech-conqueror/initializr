...
import com.techconqueror.initializr.contributor.NTierFileProjectContributor;
...
public class ProjectContributorConfiguration {
  ...
  @Bean
  public NTierFileProjectContributor layerFileProjectContributor(ProjectDescription projectDescription) {
    return new NTierFileProjectContributor(projectDescription);
  }
